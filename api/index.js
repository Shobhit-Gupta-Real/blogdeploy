...
app.use(cors({credentials:true, origin:['https://blogdeploy-frontend.vercel.app'], methods: ["POST", "GET"]})) //for allowing the credentials originated from the react localhost
